...
def duckduckgo_search(
    ...
    """
    # Формируем полный запрос с учетом site, если указан
    ...
    try:
        ...
        # Конвертируем в JSON с поддержкой кириллицы
        return json.dumps(results, ensure_ascii=False, indent=json_indent)
